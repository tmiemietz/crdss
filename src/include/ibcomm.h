...
/* Bitmask for ignoring the completion request generated by a WR            */
#define IGNORE_CQE_MASK ((uint64_t) 1 << 63)
 ...
 *
 * Returns: 0 on success or error number of ibv_post_send else.
 */
 ...
 * the CQEs generated with a IGNORE flag will not be passed to upper layers of
 * an application that uses this library.
 *
 * Params: ibctx    - mantle structure for IB context.
 ...
 *         signaled - indicates the type of sender-side CQE that shall be
 *                    generated for this RDMA request.
 *
 * Returns: 0 on success or error number of ibv_post_send else.
 */
 ...
 *
 * Note: Any RDMA requests that are sent by this function will be labelled 
 *       with the CQE ignore flag. Hence, upper layers that use this IB
 *       communication routines will not be informed about CQEs generated by
 *       writing a poll field, unless an error occured.
 *
 * Params: ibctx    - mantle structure for IB context.
